							...
							<tbody>
								<c:forEach items="${products}" var="product">
									<tr>
										...
										<td><img alt="image" src="${images}/product/${product.productId}.png" height="120px" width="120px"/></td>
										<td>${product.name}</td>
										<td>${category.name}</td>
										...
										<a href="${contextRoot}/admin/edit/product/${product.productId}" class="btn btn-default btn-sm"><span
												class="fa fa-pencil"></span></a>&nbsp; 
												<a href="${contextRoot}/admin/delete/product/${product.productId}"
